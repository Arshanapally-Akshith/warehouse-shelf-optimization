...
if st.button("Run Optimization"):
    ...
    df = pd.DataFrame({
        "Metric": ["Initial Cost", "SA Final Cost", "Greedy Final Cost", "SA Improvement %", "Greedy Improvement %"],
        "Value": [
            initial_cost,
            sa_cost,
            gr_cost,
            round((initial_cost - sa_cost)/initial_cost * 100, 2),
            round((initial_cost - gr_cost)/initial_cost * 100, 2)
        ]
    })
